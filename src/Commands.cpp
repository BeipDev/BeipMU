...
GMCP_BEGIN R"+(beip.stats {
   "Player":
   {
      ...
      {
         mp_connection->Receive(ConstString(
GMCP_BEGIN R"+(beip.tilemap.info { "Castle":{"tile-url":"https://github.com/BeipDev/BeipMU/raw/master/images/Ultima5.png", "tile-size":"16,16", "map-size":"32,32", "encoding":"zbase64_8" } })+" GMCP_END
