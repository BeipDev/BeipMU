...
LineParser::LineParser(INotify &notify)
: m_notify(notify)
{
}
...
void LineParser::Parse(Array<const char> buffer)
{
      ...
      if(m_state!=State::Normal)
      {
         switch(m_state)
         {
            ...
            case State::Will:
               ...
               #if _DEBUG
               OutputDebugString(FixedStringBuilder<256>("Unsupported Will Telnet option:", (int)(c), '\n').Terminate());
               #endif
               break;
