...
Basically a there are two types of ANSI color codes here which are inflating the string and causing it to not look right.  There is ESC [0m and ESC [1;37m
  ...
  { 
    ...
    if (work.search(/<(?:\d*\/\d*)hp (?:\d*)m (?:\d*)mv (?:-\d*)xp>/) >-1)
      { 
        ...
        xp = parseInt(work.substring(work.search(" -"),work.search("xp>")));
//        window.output.write(hp + " " + maxhp + " " + mana + " " + move + " " + xp);
